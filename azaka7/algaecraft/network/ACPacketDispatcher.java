...
import azaka7.algaecraft.network.client.*;
import azaka7.algaecraft.network.server.*;
 ...
 *
 */
public class ACPacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(AlgaeCraft.MODID);
	...
	public static final void registerPackets() {
		...
		ACPacketDispatcher.registerMessage(HandleBCDSwitchMessage.class, BCDSwitchMessage.class, Side.SERVER);
		ACPacketDispatcher.registerMessage(HandleKeyPressMessage.class, KeyPressMessage.class, Side.SERVER);
	...
	private static final void registerMessage(Class handlerClass, Class messageClass, Side side) {
		ACPacketDispatcher.dispatcher.registerMessage(handlerClass, messageClass, packetId++, side);
	}
	...
	public static final void sendTo(IMessage message, EntityPlayerMP player) {
		ACPacketDispatcher.dispatcher.sendTo(message, player);
	}
	...
	public static final void sendToAllAround(IMessage message, NetworkRegistry.TargetPoint point) {
		ACPacketDispatcher.dispatcher.sendToAllAround(message, point);
	}
	...
	public static final void sendToAllAround(IMessage message, int dimension, double x, double y, double z, double range) {
		ACPacketDispatcher.sendToAllAround(message, new NetworkRegistry.TargetPoint(dimension, x, y, z, range));
	}
	...
	public static final void sendToAllAround(IMessage message, EntityPlayer player, double range) {
		ACPacketDispatcher.sendToAllAround(message, player.worldObj.provider.dimensionId, player.posX, player.posY, player.posZ, range);
	}
	...
	public static final void sendToDimension(IMessage message, int dimensionId) {
		ACPacketDispatcher.dispatcher.sendToDimension(message, dimensionId);
	}
	...
	public static final void sendToServer(IMessage message) {
		ACPacketDispatcher.dispatcher.sendToServer(message);
