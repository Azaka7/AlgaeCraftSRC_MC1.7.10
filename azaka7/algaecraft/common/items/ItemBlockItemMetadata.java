...
public class ItemBlockItemMetadata extends ItemBlock {
	...
	public String getUnlocalizedName(ItemStack par1ItemStack)
    {
		...
		String orig = iconNameList[meta%iconNameList.length];
    ...
    {
		/*if(this.field_150939_a == ACBlocks.blockSpongeRed){
			Item.getItemFromBlock(ACBlocks.blockSpongeYellow).registerIcons(par1IconRegister);
		}*/
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ, int metadata)
    {
		...
		return super.placeBlockAt(stack, player, world, x, y, z, side, hitX, hitY, hitZ, getMetadata(metadata));
    }
