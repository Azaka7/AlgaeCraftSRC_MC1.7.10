...
public class ACPacketHandler extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("ALGAECRAFT", this);
    }
